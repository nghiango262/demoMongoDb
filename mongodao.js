...
MongoDao.prototype.createCollection = function(collectionName, callback) {
	this.dbConnection.createCollection(collectionName, function(err, result) {
		assert.equal(null, err);
		console.log(" createCollection successfully");
		callback();
	});
}
